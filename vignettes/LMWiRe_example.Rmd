...
# devtools::install_github("FranceschiniS/LMWiRe",build_vignettes = TRUE)
...
The 600 response variables are the spectrum of the H-NMR for each observations. They can be plot together with the simple `geom_line` function from the `ggplot2` package.
...
# ResLMBootstrapTest= LMBootstrapTest(ResLMEffectMatrices = ResLMEffectMatrices,TermToTest = TermToTest,nboot=100)
# 
# # Print Pvalue
# 
...
#     hist(x=ResLMBootstrapTest$SSboot[i,],xlim=c(0,max(ResLMBootstrapTest$SSEffect[i],ResLMBootstrapTest$SSboot[i,])),
#      breaks=20,main=rownames(ResLMBootstrapTest$SSboot)[i],xlab="SST III",freq=FALSE)
#     points(ResLMBootstrapTest$SSEffect[i],0,col="red",pch=19)
# }
```
...
PlotScoresMatrix(ResASCA,
                 ...
                 vec.colorup = c("black","blue","skyblue"),
                 varname.pchdown = "Day",
